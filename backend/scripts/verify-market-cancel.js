...
const MARKERS = [
  ...
  ['frontend/pages/B_host-seller/js/marketdelete.js', 'showCancelConfirm', '확인 모달'],
  ['frontend/pages/B_host-seller/js/marketdelete.js', 'getCancelPreview', '미리보기 호출'],
  ['frontend/pages/B_host-seller/js/marketdelete.js', 'confirmRefund', '확인 신호 전송'],
  ['frontend/pages/B_host-seller/js/marketdelete.js', '예, 환불하고 취소합니다', '예/아니오 버튼'],
