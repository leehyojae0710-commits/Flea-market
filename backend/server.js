...
//집 테스트 용
app.use('/api/uploads', express.static('C:uploads/markets/'));
app.use('/api/uploads', express.static('C:uploads/seller/'));
app.use('/api/uploads', express.static('C:uploads/profile/'));
